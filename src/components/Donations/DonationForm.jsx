    ...
    return (
        <StyledSignupImgWrapper className="login-img-wrapper">
            <StyledForm className='form'>
                <div className='formContent'>
                    ...
                    <div className='inputWrapper'>
                        ...
                        <input className='formInput' type='text' name='donorName' value={donorName} onChange={(e) => handleInputChange(e)} onBlur={handleInputValidation} placeholder='Your Name' />
                    </div>
                    <div className='err'>
                    ...
                    <div className='inputWrapper'>
                        ...
                        <input className='formInput' type='text' name='city' value={city} onChange={(e) => handleInputChange(e)} onBlur={handleInputValidation} placeholder='City' />
                    </div>
                    <div className='err'>
                        {<span className='err'>{cityError}</span>}
                    </div>

                    <div className='inputWrapper'>
                        <label className='formLabel'>PinCode*</label>
                        <input className='formInput' type='text' name='pincode' value={pincode} onChange={(e) => handleInputChange(e)} onBlur={handleInputValidation} placeholder='PinCode' />
                    </div>
                    <div className='err'>
                    ...
                    <div className='inputWrapper'>
                        ...
                        <input className='formInput' type='text' name='donorPhoneNumber' value={donorPhoneNumber} onChange={(e) => handleInputChange(e)} onBlur={handleInputValidation} placeholder='PhoneNumber' />
                    </div>
                    <div className='err'>
          ...
          <div>
                    ...
                    <button disabled={disabled} className='registerBtn' type='submit' onClick={(e) => handleSubmit(e)}>Next</button>
                </div>
            </StyledForm>
