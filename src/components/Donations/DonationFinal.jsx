...
function DonationFinal() {
  ...
  return (
    ...
    <label className='formLabel'>Card Number*</label>
            <input className='formInput' type="text" value={cardNumber} onChange={handleCardNumberChange} onBlur={handleInputValidation} maxLength="16"/>
      </div>
      <div className='err'>
      ...
      <label className='formLabel'>Expiration Date (MM/YY):</label>
        <input className='formInput' type="text" value={expirationDate} onChange={handleExpirationDateChange} onBlur={handleInputValidation} maxLength="4" />
      </div>
      <div className='err'>
      ...
      <label className='formLabel'>CVV:</label>
        <input className='formInput' type="text" value={cvv} onChange={handleCvvChange} onBlur={handleInputValidation} maxLength="3" pattern="\d{3}"/>
      </div>
      <div className='err'>
                        {<span className='err'>{cvvError}</span>}
                    </div><br></br>
      <button className='registerBtn' type='submit' onClick={(e) => handleSubmit(e)}> Donate</button>
    </form>
    </div>
    </StyledForm>
